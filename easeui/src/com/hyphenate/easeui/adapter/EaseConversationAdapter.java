...
//                final int count = mOriginalValues.size();//austin add annotation
                final int count = copyConversationList.size();
                final ArrayList<EMConversation> newValues = new ArrayList<EMConversation>();

                for (int i = 0; i < count; i++) {
//                    final EMConversation value = mOriginalValues.get(i);//austin annotation
                    final EMConversation value = copyConversationList.get(i);//+
//                    String username = value.conversationId();
                    String username = EaseUserUtils.getUserInfo(value.conversationId()).getNickname();
...
//                        EaseUser user = EaseUserUtils.getUserInfo(username);
                        EaseUser user = EaseUserUtils.getUserInfo(value.conversationId());
