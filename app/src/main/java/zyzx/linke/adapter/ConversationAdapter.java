...
public class ConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.list_itease_layout.setBackgroundResource(R.drawable.btn_sel2);
        ...
        if (conversation.getType() == EMConversation.EMConversationType.GroupChat) {
            ...
            try {
                //从扩展消息中获取用户信息
                headIconUrl = lastMessage.getStringAttribute(Const.MSG_FLAG_HEAD_URL);
                userId = lastMessage.getIntAttribute(Const.MSG_FLAG_UERID);
                loginName = lastMessage.getStringAttribute(Const.MSG_FLAG_LOGIN_NAME);
