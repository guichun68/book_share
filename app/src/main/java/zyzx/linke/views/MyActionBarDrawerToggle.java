 ...
 *
 * <p>To use <code>MyActionBarDrawerToggle</code>, create one in your Activity and call through
 ...
 * has occurred.</p>
 *
 * <p><code>MyActionBarDrawerToggle</code> can be used directly as a
 ...
 * ActionBar theme.
 */
public class MyActionBarDrawerToggle implements DrawerLayout.DrawerListener {

    /**
     * Allows an implementing Activity to return an {@link MyActionBarDrawerToggle.Delegate} to use
     * with MyActionBarDrawerToggle.
     */
    ...
    /**
     * Construct a new MyActionBarDrawerToggle.
     *
    ...
    /**
     * Construct a new MyActionBarDrawerToggle with a Toolbar.
     * <p>
     ...
     * <p>
     * Please use {@link #MyActionBarDrawerToggle(Activity, DrawerLayout, int, int)} if you are
     ...
     * animation.
     */
    <T extends Drawable & DrawerToggle> MyActionBarDrawerToggle(Activity activity, Toolbar toolbar,
     ...
     * may have diverged in such a way that the MyActionBarDrawerToggle was not notified.
     ...
     * MyActionBarDrawerToggle instance directly as your DrawerLayout's listener, you should call
    ...
    public void onDrawerOpened(View drawerView) {
        GlobalParams.isDrawerOpened = true;
        mSlider.setPosition(1);
        if (mDrawerIndicatorEnabled) {
    ...
    void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) {
        if (!mWarnedForDisplayHomeAsUp && !mActivityImpl.isNavigationVisible()) {
            Log.w("MyActionBarDrawerToggle", "DrawerToggle may not show up because NavigationIcon"
