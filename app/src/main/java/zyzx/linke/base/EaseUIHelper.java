...
//    private HXUserDao hxUserDao;
    ...
    public void init(Context context) {
        shareModel = new ShareModel(context);
...
//        options.setImPort(31097);
    ...
    private EMOptions initChatOptions(){
        ...
        if(shareModel.isCustomServerEnable() && shareModel.getRestServer() != null && shareModel.getIMServer() != null) {
            options.setRestServer(shareModel.getRestServer());
            options.setIMServer(shareModel.getIMServer());
            if(shareModel.getIMServer().contains(":")) {
                options.setIMServer(shareModel.getIMServer().split(":")[0]);
                options.setImPort(Integer.valueOf(shareModel.getIMServer().split(":")[1]));
            }
        }

        if (shareModel.isCustomAppkeyEnabled() && shareModel.getCutomAppkey() != null && !shareModel.getCutomAppkey().isEmpty()) {
            options.setAppKey(shareModel.getCutomAppkey());
        }
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.setSettingsProvider(new EaseSettingsProvider() {
            ...
            public boolean isSpeakerOpened() {
                return shareModel.getSettingMsgSpeaker();
            }

            @Override
            public boolean isMsgVibrateAllowed(EMMessage message) {
                return shareModel.getSettingMsgVibrate();
            }

            @Override
            public boolean isMsgSoundAllowed(EMMessage message) {
                return shareModel.getSettingMsgSound();
            }

            @Override
            public boolean isMsgNotifyAllowed(EMMessage message) {
                if(message == null){
                    return shareModel.getSettingMsgNotification();
                }
                if(!shareModel.getSettingMsgNotification()){
                    return false;
                }else{
                    ...
                    if (message.getChatType() == ChatType.Chat) {
                        ...
                        notNotifyIds = shareModel.getDisabledIds();
                    } else {
                        chatUsename = message.getTo();
                        notNotifyIds = shareModel.getDisabledGroups();
                    }
...
//                    intent = new Intent(appContext, VoiceCallActivity.class);
                    ...
                    if (chatType == ChatType.Chat) { // single chat message
                        ...
                        intent.putExtra("chatType", MyEaseConstant.CHATTYPE_SINGLE);
                    } else { // group chat message
                        // message.getTo() is the group id
                        intent.putExtra("userId", message.getTo());
                        if(chatType == ChatType.GroupChat){
                            intent.putExtra("chatType", MyEaseConstant.CHATTYPE_GROUP);
                        }else{
                            intent.putExtra("chatType", MyEaseConstant.CHATTYPE_CHATROOM);
                        }
    ...
    protected void setGlobalListeners(){
        ...
        isGroupsSyncedWithServer = shareModel.isGroupsSynced();
        isContactsSyncedWithServer = shareModel.isContactSynced();
        isBlackListSyncedWithServer = shareModel.isBacklistSynced();
        ...
        connectionListener = new EMConnectionListener() {
            ...
            public void onDisconnected(int error) {
                ...
                if (error == EMError.USER_REMOVED) {
                    onUserException(MyEaseConstant.ACCOUNT_REMOVED);
...
//        hxUserDao = HXUserDao.getInstance();
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
            ...
            broadcastManager.sendBroadcast(new Intent(MyEaseConstant.ACTION_GROUP_CHANAGED));
        }
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactAdded(String username) {
            ...
            broadcastManager.sendBroadcast(new Intent(MyEaseConstant.ACTION_CONTACT_CHANAGED));
        }
...
//            return getUserProfileManager().getCurrentUserInfo();
    ...
    public void logout(boolean unbindDeviceToken, final EMCallBack callback) {
        ...
        EMClient.getInstance().logout(unbindDeviceToken, new EMCallBack() {
            ...
            public void onSuccess() {
                ...
                shareModel.setContactSynced(false);
                reset();
                if (callback != null) {
                    callback.onSuccess();
                }
    ...
    public void setCurrentUserName(String username){
        ...
        shareModel.setCurrentUserName(username);
    }
    ...
    public String getCurrentUsernName(){
        if(username == null){
            username = shareModel.getCurrentUsernName();
        }
        return username;
    }
    ...
    public Map<String, RobotUser> getRobotList() {
        if (isLoggedIn() && robotList == null) {
            robotList = shareModel.getRobotList();
        }
        return robotList;
    }
    ...
    public void updateContactList(List<EaseUser> contactInfoList) {
        ...
        shareModel.saveContactList(mList);
    }
        ...
        new Thread(){
            ...
            public void run(){
                try {
                    ...
                    shareModel.setGroupsSynced(true);
                    ...
                    shareModel.setGroupsSynced(false);
                    isGroupsSyncedWithServer = false;
                    isSyncingGroupsWithServer = false;
                    noitifyGroupSyncListeners(false);
                    if(callback != null){
        ...
        new Thread(){
            ...
            public void run(){
                try {
                    ...
                    shareModel.setBlacklistSynced(true);
                    ...
                    shareModel.setBlacklistSynced(false);
