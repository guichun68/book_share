...
public class ForceUpdateActivityOld extends Activity {
        ...
        mBtn_ok.setOnClickListener(new OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   new Thread(new Runnable() {
                        @Override
                        public void run() {
                            UIUtil.showToastSafe("正在下载……");
                            downloadFile();
                        }
                    }).start();
               }
        });
//        mBtn_ok.setOnClickListener(new OnClickListener(View v)  {
//            ll_btn.setVisibility(View.GONE);
//            mProgressBar1.setVisibility(View.VISIBLE);
//            new Thread(new Runnable() {
//                @Override
...
//        });
        mBtn_cancel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.cancel();
                ((BaseApplication) BaseApplication.getApplication()).exitApp(ForceUpdateActivityOld.this);
            }
        });
        dialog.show();

        int height = AppUtil.getScreenHeight(ForceUpdateActivityOld.this);
        int width = AppUtil.getScreenWidth(ForceUpdateActivityOld.this);
    ...
    protected void downloadFile() {
        ...
        DownloadUtil.get().download(url, GlobalParams.BaseDir, null, new DownloadUtil.OnDownloadListener() {
            ...
            public void onDownloadSuccess() {
                ...
                Toast.makeText(ForceUpdateActivityOld.this, "已下载到" + downloadFile.getAbsolutePath(), Toast.LENGTH_LONG).show();
            ...
            public void onDownloadFailed() {
                ...
                ForceUpdateActivityOld.this.finish();
            }
        });
    }
