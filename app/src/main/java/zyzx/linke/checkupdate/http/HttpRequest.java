package zyzx.linke.checkupdate.http;
...
import zyzx.linke.checkupdate.callback.CheckUpdateCallback;
import zyzx.linke.checkupdate.callback.CheckUpdateCallback2;
...
public class HttpRequest {
    ...
    public static boolean isShouldCancel() {
        return shouldCancel;
    }

    public static void setShouldCancel(boolean shouldCancel) {
        HttpRequest.shouldCancel = shouldCancel;
    }
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    while ((count = input.read(data)) != -1 && !shouldCancel) {
                        current += count;
